...
{    
	 ...
	 {   
	    ...
	    Velocity_Pwm = velocity(Encoder_Left,Encoder_Right);                  	//===ËÙ¶È»·PID¿ØÖÆ	 ¼Ç×¡£¬ËÙ¶È·´À¡ÊÇÕı·´À¡£¬
																																																								//¾ÍÊÇĞ¡³µ¿ìµÄÊ±ºòÒªÂıÏÂÀ´¾ÍĞèÒªÔÙÅÜ¿ìÒ»µã
 		  Moto1 = -Balance_Pwm+Velocity_Pwm;                  //===¼ÆËã×óÂÖµç»ú×îÖÕPWM
 	  	Moto2 = -Balance_Pwm+Velocity_Pwm;                  //===¼ÆËãÓÒÂÖµç»ú×îÖÕPWM

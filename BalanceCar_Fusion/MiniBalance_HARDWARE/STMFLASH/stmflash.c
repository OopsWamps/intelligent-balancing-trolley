...
/* Read PID parameters from Flash.
 * Stores 7 parameters at 100x scale (absolute values for negative params).
 * [0]=Balance_Kp*100  [1]=Balance_Kd*100  [2]=Velocity_Kp*100
 * [3]=Velocity_Ki*100  [4]=Turn_Kd*100     [5]=-Dist_Kp*100
 * [6]=-Dist_Ki*100 (rounds to 0 for very small values) */
void Flash_Read(void)
{
	...
	else
	{
		...
		Turn_Kd=(float)PID_Parameter[4]/100;
		Dist_Kp=-(float)PID_Parameter[5]/100;
		Dist_Ki=-(float)PID_Parameter[6]/100;
	}
}

void Flash_Write(void)
{
	Flash_Parameter[0]=(u16)(Balance_Kp*100);
	Flash_Parameter[1]=(u16)(Balance_Kd*100);
	Flash_Parameter[2]=(u16)(Velocity_Kp*100);
	Flash_Parameter[3]=(u16)(Velocity_Ki*100);
	Flash_Parameter[4]=(u16)(Turn_Kd*100);
	Flash_Parameter[5]=(u16)(-Dist_Kp*100);
	Flash_Parameter[6]=(u16)(-Dist_Ki*100);
